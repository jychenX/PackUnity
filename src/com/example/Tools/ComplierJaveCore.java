...
public class ComplierJaveCore {
	...
	public static void initCompiler(String packName) throws Throwable{
		
		JavaString javaString = new JavaString(packName);
		String[] javaPath={javaString.getAPSHARE(), javaString.getWXAPI(), javaString.getYXAPI()};
...
//	    JOptionPane.showMessageDialog(UIFrame.fm, "编译后");
	    ...
	    //javac命令
	    Iterable<String> savePathIterable = Arrays.asList("-d", Main.getMainClassPath() + "classFile", 
	    												"-cp", SeachSystemJAR.getSystemPath(),
	    												"-source", "1.6",
	    												"-target", "1.6");
